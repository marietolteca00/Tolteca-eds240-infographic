...
# Games from Season 3-6 for both Quick Match and Competitive
...
hero_roles <- data.frame(
  ...
  role = c("Duelist", "Vanguard", 
           ...
           "Strategist", "Strategist", 
           "Strategist", "Duelist", 
           "Vanguard", "Strategist","Strategist", "Duelist"))
...
clean_season <- bind_rows(
  clean_season,
  clean_season %>% mutate(season_label = "All Seasons")
)
...
ggplot(clean_season, aes(x = kd_ratio, y = damage_per_min, color = factor(win_rate))) +
  geom_point(alpha = 0.5) +
  labs(x = "K/D Ratio", y = "Damage per Minute", 
       title = "K/D vs Damage Output", color = "Win")

# Boxplot comparison
ggplot(clean_season, aes(x = factor(win_rate), y = kd_ratio)) +
  geom_boxplot(fill = "lightgreen") +
  labs(x = "Match Result (0=Loss, 1=Win)", y = "K/D Ratio",
       title = "K/D Ratio by Match Outcome")

ggplot(clean_season, aes(x = factor(win_rate), y = damage_per_min)) +
